...
public class Holst {
    ...
    private final JButton but4 = new JButton("Кольцо");
    ...
    public JPanel northPanel() {
        ...
        but5.addActionListener(e -> {
            ...
            if (numbut == 1) {
                ...
                if (ring == null) {
                    ...
                    ring = new Ring(c1, c2, c3, Color.GREEN);
                    ((Ring) ring).Show(VISION);
                    cP.add(ring, BorderLayout.CENTER);
                    cP.revalidate();
                }
                else {
                    JOptionPane.showMessageDialog(h, "Кольцо уже нарисовано");
                }
            }
                ...
                if (rings == null) {
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        rings[i] = new Ring(c1, c2, c3, Color.GREEN);
                        rings[i].Show(VISION);
                    ...
                    JOptionPane.showMessageDialog(h, "Кольца уже нарисованы");
                }
            }
        ...
        but6.addActionListener(e -> {
            ...
            if (numbut == 1) {
                ...
                if (ring != null) {
                    ((Ring) ring).moveTo(c1, c2);
                    ((Ring) ring).Show(VISION);
                    cP.repaint();
                }
                else {
                    JOptionPane.showMessageDialog(h, "Кольцо не создано");
                }
            }
                ...
                if (rings != null) {
                    ...
                    JOptionPane.showMessageDialog(h, "Массив колец не создан ");
                }
            }
        ...
        but7.addActionListener(e -> {
            ...
            if (numbut == 1) {
                ...
                if (ring != null) {
                    ...
                    JOptionPane.showMessageDialog(h, "Кольцо не найдено");
                }
            }
                ...
                if (rings != null) {
                    ...
                    JOptionPane.showMessageDialog(h, "Массив колец не найден");
                }
            }
        });
